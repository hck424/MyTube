...
//        self.sessionManager = [[AFHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:YOUTUBE_PREFIX_URL] sessionConfiguration:config];
//        [sessionManager.requestSerializer setTimeoutInterval:120];
...
//    
//    [sessionManager GET:url parameters:nil headers:nil progress:^(NSProgress * _Nonnull downloadProgress) {
